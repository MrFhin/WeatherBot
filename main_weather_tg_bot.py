...
async def get_weather(message: types.Message):
    ...
    button = InlineKeyboardButton(text='Прогноз на 3 дні', callback_data='id')
    in_more_detail = InlineKeyboardButton(text='Подробніше', url=f"https://ua.sinoptik.ua/погода-{text.lower()}")
    markup.add(button, in_more_detail)

    # Ініціалізація кнопки 'Назад'
    markup2 = InlineKeyboardMarkup()
    return_button = InlineKeyboardButton(text='Назад', callback_data='id2')
